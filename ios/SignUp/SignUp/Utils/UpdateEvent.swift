...
enum IDError: Error {
    ...
    var description: String {
        ...
        case .networkError: return "네트워크 연결이 불안정합니다."
        }
    }
}
...
enum UpdateEvent {
    ...
    func post() {
        switch self {
        case .id(result: _): UpdateEvent.center.post(name: .idValidationResultDidUpdate, object: self)
        }
    }
}
...
extension Notification.Name {
    static let idValidationResultDidUpdate = Notification.Name(rawValue: "idValidationDidUpdate")
}
